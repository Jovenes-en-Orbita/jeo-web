  ...
  return (
    <section id="newsletter-seccion" className="py-24 bg-zinc-950 border-t border-zinc-900 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        <p className="text-zinc-400  font-light max-w-xl mx-auto mb-10 leading-relaxed">
        ...
        {status === "success" ? (
          <motion.div
            ...
            className="p-4 max-w-md mx-auto rounded-none bg-green-500/10 border border-green-500/20 text-green-400 font-bold uppercase tracking-wider"
          >
            {t("success")}
          </motion.div>
        ) : (
          <form onSubmit={handleSubmit} className="max-w-md mx-auto space-y-4">
            ...
            <button
              ...
              className="w-full py-4 rounded-none bg-nasa-red hover:bg-red-700 text-white font-bold uppercase  tracking-widest transition-all duration-300 disabled:opacity-50 cursor-pointer"
            >
              {status === "loading" ? t("subscribing") : t("subscribe")}
            </button>
            {status === "error" && (
              <p className=" text-red-500 font-bold mt-2 uppercase tracking-wide">
                {t("error")}
              </p>
            )}
            <p className=" text-zinc-500 text-center uppercase tracking-widest font-mono">
              {t("noSpam")}
            </p>
          </form>
        )}
