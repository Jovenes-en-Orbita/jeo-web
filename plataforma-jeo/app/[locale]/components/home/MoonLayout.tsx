...
const moonData = [
  { key: "ganymede", rank: 1, image: "https://i.postimg.cc/65BzYHbL/Captura-2.png", href: "/lunas/ganimedes" },
  { key: "titan", rank: 2, image: "https://i.postimg.cc/QtHV8rMk/Tit-Tan-1.png", href: "/lunas/titan" },
  { key: "callisto", rank: 3, image: "https://i.ibb.co/ynGTyY4/2due.png", href: "/lunas/calisto" },
  { key: "io", rank: 4, image: "https://i.postimg.cc/8czJrrwW/ioNN-1.png", href: "/lunas/io" },
  { key: "theMoon", rank: 5, image: "https://i.postimg.cc/FRDX1f72/Captura-1.png", href: "/lunas/la-luna" },
] as const;
    ...
    <section id="lunas" className="py-24 lg:py-32 px-4 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-10">
        ...
        <div className="flex flex-row lg:flex-col gap-4">
          {leftMoons.map((moon) => (
            <Link key={moon.key} href={moon.href} className="group">
